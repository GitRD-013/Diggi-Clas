...
const FeeManagement = () => {
  ...
  // Update handleSearchChange to sync with global context
  ...
  // Update handleClearSearch to sync with global context
      ...
      {filterPanelOpen && (
        ...
        >
          <Grid container spacing={3}>
            ...
            <Grid item xs={12} sm={6} md={4}>
              <InputBase
                placeholder="Search by student, fee ID, or class..."
